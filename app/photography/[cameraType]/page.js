...
export default async function Photos({ params: { cameraType } }) {
  ...
  return  (<div className='my-8 mx-8 flex flex-col'>
        <div className='w-11/12 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8 grow'>
          {
