...
![workflow of user upload and processing](https://krishnadubagunta.com/images/karma-upload-flow.png "Workflow of user uploads and image processing notifications")
